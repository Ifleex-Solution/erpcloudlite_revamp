...
@Component({
  ...
  templateUrl: './oop-form.component.html',
  styleUrl: './oop-form.component.scss'
})
export class OopFormComponent implements OnInit {
  form!: FormGroup;
  isEdit = false;
  id: number | null = null;
  loading = false;
  ...
  goBack() { this.router.navigate(['/product/oop/list']); }
